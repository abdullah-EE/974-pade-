    ...
    <View>
      <ScrollView ref={ref} horizontal pagingEnabled snapToInterval={slideWidth} decelerationRate="fast" showsHorizontalScrollIndicator={false} onMomentumScrollEnd={onScrollEnd}>
        {slides.map((court, index) => {
          ...
          return (
          <View key={court.id} style={styles.slide}>
...
const styles = StyleSheet.create({
  slide: { width: slideWidth, height: 326, marginRight: 0, borderRadius: radius.xl, overflow: 'hidden', backgroundColor: colors.deep, shadowColor: '#000', shadowOpacity: 0.24, shadowRadius: 24, shadowOffset: { width: 0, height: 16 }, elevation: 10, transform: [{ perspective: 900 }, { rotateX: '0.8deg' }] },
