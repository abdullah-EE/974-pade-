...
const styles = StyleSheet.create({
  ...
  podiumFirst: { borderColor: colors.hotPink, borderWidth: 2, shadowColor: colors.hotPink, shadowOpacity: 0.32 },
  ...
  row: { flexDirection: 'row', alignItems: 'center', gap: 9, backgroundColor: colors.glass, borderRadius: radius.md, padding: 12, borderWidth: 1, borderColor: colors.border },
